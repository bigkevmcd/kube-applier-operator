...
import (
	...
	applierv1alpha1 "github.com/bigkevmcd/k8s-applier/pkg/apis/applier/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &applierv1alpha1.Repository{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &applierv1alpha1.Repository{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileRepository) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &applierv1alpha1.Repository{}
...
func newPodForCR(cr *applierv1alpha1.Repository) *corev1.Pod {
